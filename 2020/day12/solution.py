...
next_state_funcs_part1 = {
    **dict.fromkeys(['N', 'S', 'E', 'W'],
                    lambda s, i: State(s.pos + dir_vec[i.typ] * i.val, s.dir)),
...
next_state_funcs_part2 = {
    **next_state_funcs_part1,
    **dict.fromkeys(['N', 'S', 'E', 'W'],
                    lambda s, i: State(s.pos, s.dir + dir_vec[i.typ] * i.val)),
}
...
last_state_part2 = get_last_state(instructions, np.array((10, 1)), next_state_funcs_part2)

print('part 1:', np.abs(last_state_part1.pos).sum())
print('part 2:', np.abs(last_state_part2.pos).sum())
